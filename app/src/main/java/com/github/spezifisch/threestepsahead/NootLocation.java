 ...
 */
public class NootLocation implements Parcelable {
    /**
     ...
     */
    public NootLocation(String provider) {
        mProvider = provider;
    }
     ...
     */
    public NootLocation(NootLocation l) {
        set(l);
    }
     ...
     */
    public void set(NootLocation l) {
     ...
     */
    public float distanceTo(NootLocation dest) {
     ...
     */
    public float bearingTo(NootLocation dest) {
        synchronized (mResults) {
            // See if we already have the result
            if (mLatitude != mLat1 || mLongitude != mLon1 ||
                    dest.mLatitude != mLat2 || dest.mLongitude != mLon2) {
    ...
    public static final Parcelable.Creator<NootLocation> CREATOR =
            new Parcelable.Creator<NootLocation>() {
                @Override
                public NootLocation createFromParcel(Parcel in) {
                    String provider = in.readString();
                    NootLocation l = new NootLocation(provider);
                    l.mTime = in.readLong();
     ...
     * @return the extra NootLocation, or null if unavailable
     * @hide
     */
    public NootLocation getExtraLocation(String key) {
        if (mExtras != null) {
            Parcelable value = mExtras.getParcelable(key);
            if (value instanceof NootLocation) {
                return (NootLocation) value;
            }
        }
        return null;
    }
     ...
     * @hide
     */
    public void setExtraLocation(String key, NootLocation value) {
        if (mExtras == null) {
            mExtras = new Bundle();
        }
    ...
    public void displace(double distance, double theta) {
        ...
        mLatitude = Math.toDegrees(lat2);
        mLongitude = Math.toDegrees(lng2);
    }
}
